function output=model_ToRORd_LandCaMKSKJrelpKinetics(t,X,flag_ode, cellType, ICaL_Multiplier, ...
...
gkca= 0.003;%%%0.012;
ikcan=3.5;
kdikca=6.05e-04;%%%%6.05e-04;%%%%%mM for Ctrl, 3.45e-04%%%%%mM for HF
FractionIKCass=0.8;
...
%% Jrel
[Jrel, dJrel_np, dJrel_p] = getJrel_ORd2011(Jrel_np, Jrel_p, ICaL_ss,cass, cajsr, fJrelp, celltype, Jrel_Multiplier,Jrelptau_Multiplier);
...
if flag_ode==1
    ...
    output=[INa INaL Ito ICaL IKr IKs IK1 INaCa_i INaCa_ss INaK  IKb INab ICab IpCa Jdiff JdiffNa JdiffK Jup Jleak Jtr Jrel CaMKa Istim, fINap, ...
        fINaLp, fICaLp, fJrelp, fJupp, cajsr, cansr, PhiCaL_ss, v, ICaL_i, I_ClCa, I_Clbk, ICaL_tot, Bcai, IKCa, Ta];
end
...
%% Jrel
function [Jrel, dJrelnp, dJrelp] = getJrel_ORd2011(Jrelnp, Jrelp, ICaL, cass, cajsr, fJrelp, celltype, Jrel_Multiplier,Jrelptau_Multiplier)
jsrMidpoint = 1.7;
